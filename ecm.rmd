...
```{r,echo=FALSE, fig.height=40, fig.width=30, message=FALSE, warning=FALSE,fig.align ='center', fig.cap='Количество смертей от передозировок опиоидами (на 100 000 населения штата)'}
plot1
```
